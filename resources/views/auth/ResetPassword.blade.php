...
<html>
    ...
    <head>
        ...
        <title>Reset Password - SIAKAD AZCA</title>
        ...
        <section class="flex h-dvh w-screen items-center justify-center">
            <div class="box flex rounded border bg-white" style="width:70%; max-width: 90%;">
                <div class="left-box relative hidden w-8/12 px-10 py-5 lg:block">
                    ...
                    <p class="text-light text-slate-500">Akses informasi akademik Anda (nilai, jadwal, tugas, materi, dan lainnya) dengan mudah di sini.</p>
                ...
                <div class="flex w-full items-center justify-center px-10 py-10 pb-10">
                    <div class="w-full">
                        ...
                        <h1 class="my-10 text-center text-xl font-medium text-slate-600">Reset Password</h1>
                        <form class="space-y-4 md:mx-14 md:space-y-6" action="/reset-password/submit" method="post">
                            @csrf
                            ...
                            <div>
                                <label for="password" class="mb-2 block text-sm font-light text-gray-700">Password</label>
                                <input type="password" name="password" id="password" placeholder="Password..." class="@error('password') border-red-600 @enderror form-password shadow-xs block w-full rounded-lg border bg-gray-50 p-2.5 py-3 text-sm text-gray-900 focus:border-blue-600 focus:ring-blue-600">
                                @error('password')
                                    <p class="pt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                <label for="password_confirmation" class="mb-2 block text-sm font-light text-gray-700">Konfirmasi Password</label>
                                <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Konfirmasi Password..." class="@error('password_confirmation') border-red-600 @enderror form-password shadow-xs block w-full rounded-lg border bg-gray-50 p-2.5 py-3 text-sm text-gray-900 focus:border-blue-600 focus:ring-blue-600">
                            ...
                            <div class="mb-4 flex items-center">
                                ...
                                <label for="default-checkbox" class="ms-2 text-sm font-medium text-gray-900">Tampilkan Password</label>
                            </div>
