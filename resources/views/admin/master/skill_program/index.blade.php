...
@section('content')
    <div class="grid grid-cols-1 rounded-lg bg-white px-5 py-6">
        <div class="header flex flex-col items-center justify-between gap-5 border-b pb-5 md:flex-row">
            <div>
                <h1 class="text-lg font-semibold text-red-600"><i class="bi bi-book-half pe-2"></i> Daftar Program Keahlian</h1>
            </div>
            <div>
                <a href="/program-keahlian/create">
            ...
            <table id="pagination-table" class="w-full">
                <thead>
                    <tr>
                        ...
                        <th class="border">
                            <div class="flex h-full items-center">Program Keahlian</div>
                        </th>
                        <th class="border">
                    ...
                    @foreach ($skill as $s)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="/program-keahlian/{{ Crypt::encrypt($s->id_skill) }}/edit"><i class="bi bi-pencil-square mr-3 text-lg text-green-600 hover:text-green-900"></i></a>
                                <a href="/program-keahlian/{{ Crypt::encrypt($s->id_skill) }}/delete"><i class="bi bi-trash text-lg text-green-600 hover:text-green-900"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
