...
@section('content')
    <div class="grid grid-cols-1 rounded-lg bg-white px-5 py-6">
        ...
        <div class="body">
            ...
            <form class="my-6" action="/semester/{{ Crypt::encrypt($semester->id_semester) }}" method="post">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" class="@error('name') border-red-600 @enderror block w-full rounded-lg border bg-gray-50 p-2.5 text-sm text-gray-600 focus:border-red-500 focus:ring-red-500" placeholder="Nama Semester..." value="{{ $semester->name }}" autocomplete="off" />
                        @error('name')
                    ...
                    <div>
                        ...
                        <input type="text" id="code" name="code" class="@error('code') border-red-600 @enderror block w-full rounded-lg border bg-gray-50 p-2.5 text-sm text-gray-600 focus:border-red-500 focus:ring-red-500" placeholder="Kode..." value="{{ $semester->code }}" autocomplete="off" />
                        @error('code')
                            <p class="pt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select name="id_semester_type" id="id_semester_type" name="id_semester_type" class="@error('id_semester_type') border-red-600 @enderror js-select2 block w-full rounded-lg border bg-gray-50 p-2.5 text-sm text-gray-600 focus:border-red-500 focus:ring-red-500">
                            <option selected value="{{ $semester->id_semester_type }}">-- {{ $semester->semester_type->name }} --</option>
                    ...
                    <div>
                        ...
                        <select name="status" id="status" name="status" class="@error('status') border-red-600 @enderror js-select2 block w-full rounded-lg border bg-gray-50 p-2.5 text-sm text-gray-600 focus:border-red-500 focus:ring-red-500">
                            <option selected value="{{ $semester->status }}">-- {{ $semester->status }} --</option>
                        ...
                        <div class="flex items-start pt-8">
                            <div class="flex h-5 items-center">
                                <input id="final_level" type="checkbox" name="final_level" value="{{ 1 }}" class="focus:ring-3 h-4 w-4 rounded-sm border border-gray-300 bg-gray-50 focus:ring-blue-300" @if ($semester->final_level == 1) checked @endif />
                            </div>
                    ...
                    <div class="pt-4">
                        ...
                        <input type="number" id="attendance" name="attendance" class="@error('attendance') border-red-600 @enderror block w-full rounded-lg border bg-gray-50 p-2.5 text-sm text-gray-600 focus:border-red-500 focus:ring-red-500" placeholder="Nilai Absensi..." value="{{ $semester->attendance }}" autocomplete="off" />
                        @error('attendance')
                            <p class="pt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="pt-4">
                        ...
                        <input type="number" id="daily_score" name="daily_score" class="@error('daily_score') border-red-600 @enderror block w-full rounded-lg border bg-gray-50 p-2.5 text-sm text-gray-600 focus:border-red-500 focus:ring-red-500" placeholder="Nilai Harian..." value="{{ $semester->daily_score }}" autocomplete="off" />
                        @error('daily_score')
                            <p class="pt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="mid_term_score" name="mid_term_score" class="@error('mid_term_score') border-red-600 @enderror block w-full rounded-lg border bg-gray-50 p-2.5 text-sm text-gray-600 focus:border-red-500 focus:ring-red-500" placeholder="Nilai PTS..." value="{{ $semester->mid_term_score }}" autocomplete="off" />
                    ...
                    <div>
                        ...
                        <input type="number" id="final_term_score" name="final_term_score" class="@error('final_term_score') border-red-600 @enderror block w-full rounded-lg border bg-gray-50 p-2.5 text-sm text-gray-600 focus:border-red-500 focus:ring-red-500" placeholder="Nilai PAS..." value="{{ $semester->final_term_score }}" autocomplete="off" />
