...
@section('content')
    <div class="grid grid-cols-1 rounded-lg bg-white px-5 py-6">
        <div class="header flex flex-col items-center justify-between gap-5 border-b pb-5 md:flex-row">
            <div>
                <h1 class="text-lg font-semibold text-red-600"><i class="bi bi-book-half pe-2"></i> Hapus Divisi</h1>
            </div>
            <div>
        ...
        <div class="body">
            <form class="my-6" action="/divisi/{{ Crypt::encrypt($division->id_division) }}" method="post">
                ...
                <table class="w-full" cellpadding="10">
                    <tr height="40">
                        <td width="150"><b>Nama Divisi</b></td>
                        <td width="12">:</td>
                        <td>{{ $division->name }}</td>
                    </tr>
                    <tr height="40">
                        <td><b>Jam Masuk</b></td>
                        <td>:</td>
                        <td>{{ $division->time_in }} - {{ $division->time_out }}</td>
                    </tr>
                </table>
