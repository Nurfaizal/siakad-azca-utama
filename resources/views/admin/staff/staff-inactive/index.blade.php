...
@section('content')
    <div class="grid grid-cols-1 rounded-lg bg-white px-5 py-6">
        <div class="header flex flex-col items-center justify-between gap-5 border-b pb-5 md:flex-row">
            <div>
                <h1 class="text-lg font-semibold text-red-600"><i class="bi bi-book-half pe-2"></i> Daftar Guru & Staff Non Aktif</h1>
            </div>
            <div>
            </div>
        </div>
            ...
            <table id="pagination-table" class="w-full">
                <thead>
                    <tr>
                        ...
                        <th class="border">
                            <div class="flex h-full items-center">Username</div>
                        </th>
                        <th class="border">
                    ...
                    @foreach ($staff as $s)
                        <tr>
                            ...
                            <td class="flex justify-center gap-2">
                                <a href="/staff/{{ Crypt::encrypt($s->id_staff) }}"><i class="bi bi-eye mr-3 text-lg text-green-600 hover:text-green-900"></i></a>
                                <a href="/staff/{{ Crypt::encrypt($s->id_staff) }}/edit"><i class="bi bi-pencil-square mr-3 text-lg text-green-600 hover:text-green-900"></i></a>
                                <a href="/staff/{{ Crypt::encrypt($s->id_staff) }}/delete"><i class="bi bi-trash text-lg text-green-600 hover:text-green-900"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
