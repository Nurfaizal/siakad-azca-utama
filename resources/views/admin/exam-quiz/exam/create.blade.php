...
@section('content')
    <div class="grid grid-cols-1 rounded-lg bg-white px-5 py-6">
        <div class="header flex flex-col items-center justify-between gap-5 border-b pb-5 md:flex-row">
            <div>
                <h1 class="text-lg font-semibold text-red-600"><i class="bi bi-book-half pe-2"></i> Buat Ujian/Quiz</h1>
            </div>
            <div>
                <a href="/ujian-quiz"
        ...
        <div class="body">
            <div class="flex justify-center">
                <div class="grid grid-cols-5 gap-2 w-full lg:w-1/2">
                    <div class="flex flex-col items-center gap-4">
                        <i class="bi bi-card-heading text-teal-600" style="font-size: 4rem;"></i>
                        <h1 class="text-teal-600 text-sm font-bold text-center">1. Detail Ujian/Kuis</h1>
                    </div>
                    <div class="flex items-center justify-center">
                        <i class="bi bi-arrow-right text-slate-400" style="font-size: 2rem;"></i>
                    </div>
                    <div class="flex flex-col items-center gap-4">
                        <i class="bi bi-people text-slate-500" style="font-size: 4rem;"></i>
                        <h1 class="text-slate-500 text-sm font-bold text-center">2. Penetapan Peserta</h1>
                    </div>
                    <div class="flex items-center justify-center">
                        <i class="bi bi-arrow-right text-slate-400" style="font-size: 2rem;"></i>
                    </div>
                    <div class="flex flex-col items-center gap-4">
                        <i class="bi bi-pencil text-slate-500" style="font-size: 4rem;"></i>
                        <h1 class="text-slate-500 text-sm font-bold text-center">3. Buat Soal</h1>
                    </div>
                </div>
            </div>


            <form class="mt-16" action="/ujian-quiz" method="post">
                @csrf
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name"
                            ...
                            placeholder="Nama Ujian..." value="{{ old('name') }}" autocomplete="off" />
                        @error('name')
                    ...
                    <div>
                        ...
                        <select name="id_subject" id="id_subject" name="id_subject"
                            class="@error('id_subject') border-red-600 @enderror js-select2 block w-full rounded-lg border p-2.5 text-sm text-gray-600 focus:border-red-500 focus:ring-red-500 bg-white">
                    ...
                    <div>
                        ...
                        <input type="date" id="exam_date" name="exam_date"
                            class="@error('exam_date') border-red-600 @enderror block w-full rounded-lg border  p-2.5 text-sm text-gray-600 focus:border-red-500 focus:ring-red-500"
                            placeholder="Nama Ujian..." value="{{ old('exam_date') }}" autocomplete="off" />
                        @error('exam_date')
                            <p class="pt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select name="supervisor" id="supervisor" name="supervisor"
                            class="@error('supervisor') border-red-600 @enderror js-select2 block w-full rounded-lg border p-2.5 text-sm text-gray-600 focus:border-red-500 focus:ring-red-500 bg-white">
                    ...
                    <div>
                        ...
                        <select name="corrector" id="corrector" name="corrector"
                            class="@error('corrector') border-red-600 @enderror js-select2 block w-full rounded-lg border p-2.5 text-sm text-gray-600 focus:border-red-500 focus:ring-red-500 bg-white">
                            <option selected value="">-- Pilih Pengoreksi --</option>
                            @foreach ($staff as $s)
                                <option value="{{ $s->name }}">{{ $s->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        <div class="flex items-start pt-7">
                            <div class="flex h-5 items-center">
                                <input id="show_poin" type="checkbox" name="show_poin" value="1"
                                    class="focus:ring-3 h-4 w-4 rounded-sm border border-gray-300 bg-gray-50 focus:ring-blue-300" />
                            </div>
                            <label for="show_poin" class="ms-2 text-sm font-medium text-gray-900">Tampilkan Nilai</label>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex items-start">
                            <div class="flex h-5 items-center">
                                <input id="score_show" type="checkbox" name="score_show" value="{{ 1 }}" class="focus:ring-3 h-4 w-4 rounded-sm border border-gray-300 bg-gray-50 focus:ring-blue-300" />
                            </div>
