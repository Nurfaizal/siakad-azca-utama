...
@section('content')
    <div class="grid grid-cols-1 rounded-lg bg-white px-5 py-6">
        ...
        <div class="header flex flex-col items-center justify-between gap-5 border-b pb-5 md:flex-row">
            <div>
                <h1 class="text-lg font-semibold text-red-600"><i class="bi bi-book-half pe-2"></i> Daftar Siswa</h1>
            </div>
            <div class="flex">
                <button class="h-10 min-w-28 rounded-l-lg bg-violet-100 font-semibold text-violet-700 duration-150 ease-linear hover:bg-violet-200"><i class="bi bi-journal-arrow-down pe-1"></i>
                    Ekspor</button>
                <a href="/siswa/create">
                    <button class="h-10 min-w-28 rounded-r-lg bg-green-100 font-semibold text-green-700 duration-150 ease-linear hover:bg-green-200"><i class="bi bi-plus-lg pe-1"></i>
                        Tambah</button>
                </a>
            </div>
        </div>
            ...
            <table id="pagination-table" class="w-full">
                <thead>
                    <tr>
                        ...
                        <th class="border">
                            <div class="flex h-full items-center">Nama Wali</div>
                        </th>
                        <th class="border">
                    ...
                    @foreach ($students as $student)
                        <tr>
                            ...
                            <td class="flex justify-center gap-2">
                                <a href="/siswa/{{ Crypt::encrypt($student->id_student) }}"><i class="bi bi-eye mr-3 text-lg text-green-600 hover:text-green-900"></i></a>
                                <a href="/siswa/{{ Crypt::encrypt($student->id_student) }}/edit"><i class="bi bi-pencil-square mr-3 text-lg text-green-600 hover:text-green-900"></i></a>
                                <a href="/siswa/{{ Crypt::encrypt($student->id_student) }}/delete"><i class="bi bi-trash text-lg text-green-600 hover:text-green-900"></i></a>
                            </td>
                        </tr>
                    @endforeach
