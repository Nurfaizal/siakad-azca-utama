...
@section('content')
    <div class="grid grid-cols-1 rounded-lg bg-white px-5 py-6">
        <div class="header flex flex-col items-center justify-between gap-5 border-b pb-5 md:flex-row">
            <div>
                <h1 class="text-lg font-semibold text-red-600"><i class="bi bi-book-half pe-2"></i> Ubah Lokasi Absen</h1>
            </div>
            <div>
                <a href="/lokasi-gps"
                    ...
                    <div>
                        <div>
                            ...
                            <div style="margin-top: 1rem;">
                                <label>Latitude: <input type="text"
                                ...
                                <label>Longitude: <input type="text"
                    ...
                    <div>
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" name="name"
                                ...
                                placeholder="Nama Lokasi..." value="{{ $gpsLocation->name }}" autocomplete="off" />
                            @error('name')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
                            <div>
                                ...
                                <input type="number" id="distance" name="distance"
                                    ...
                                    placeholder="Jarak Radius..." value="{{ $gpsLocation->distance }}" autocomplete="off" />
                                @error('distance')
                                    <p class="pt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="number" id="late_tolerance" name="late_tolerance"
                                    ...
                                    placeholder="15" value="{{ $gpsLocation->late_tolerance }}" autocomplete="off" />
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="address" id="address" rows="3"
                                ...
                                placeholder="Alamat...">{{ $gpsLocation->address }}</textarea>
                            @error('address')
                                <p class="pt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" rows="3"
                                ...
                                placeholder="Deskripsi...">{{ $gpsLocation->description }}</textarea>
                            @error('description')
                                <p class="pt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                            <div class="relative">
                                ...
                                <input type="time" id="start_time" name="start_time"
                                    ...
                                    value="{{ $gpsLocation->start_time ? \Carbon\Carbon::parse($gpsLocation->start_time)->format('H:i') : '' }}" />
                            ...
                            <div class="relative">
                                ...
                                <input type="time" id="end_time" name="end_time"
                                    ...
                                    value="{{ $gpsLocation->end_time ? \Carbon\Carbon::parse($gpsLocation->end_time)->format('H:i') : '' }}" />
                                <i class="bi bi-alarm absolute right-4 top-1/2"></i>
                                @error('end_time')
                                    <p class="pt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="grid grid-cols-1 gap-3 mb-3">
                            <label class="required block text-sm font-medium text-gray-600">Hari</label>
                            <div class="flex flex-wrap gap-2">
                                @foreach (['Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat', 'Sabtu', 'Minggu'] as $day)
                                    <div class="mb-4">
                                        <input type="checkbox" name="days[]" value="{{ $day }}"
                                            id="{{ strtolower($day) }}" class="hidden peer"
                                        ...
                                        <label for="{{ strtolower($day) }}"
                                            class="cursor-pointer px-4 py-2 rounded border border-gray-300 bg-white text-gray-700 
                                                ...
                                                peer-checked:bg-teal-500 peer-checked:text-white transition">
                                            {{ $day }}
                                        </label>
                                    </div>
                                @endforeach
                        ...
                        <div>
                            <label for="status"
                                class="required mb-2 block text-sm font-medium text-gray-600">Status</label>
