    ...
    <div class="grid grid-cols-2">
        ...
        <div class="grid grid-cols-1 rounded-lg bg-white px-5 py-6">
            <div class="header flex flex-col items-center justify-between gap-5 border-b pb-5 md:flex-row">
                <div>
                    <h1 class="text-lg font-semibold text-red-600"><i class="bi bi-book-half pe-2"></i> Hapus Mata Pelajaran
                    </h1>
                </div>
                <div>
                    <a href="/jadwal-mapel"
            ...
            <div class="body">
                <form class="my-6" action="/jadwal-mapel/{{ Crypt::encrypt($schedule->id_schedule) }}"
                    ...
                    <table class="w-full" cellpadding="10">
                        <thead>
                            <tr>
                                <th class="font-medium text-slate-800" colspan="3">Detail Jadwal</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="border-b">
                                <td class="text-slate-800" width="150">Mata Pelajaran</td>
                                <td class="text-slate-600" width="30">:</td>
                                <td class="text-slate-600 font-light">{{ $schedule->subject->name }}</td>
                            </tr>
                            <tr class="border-b">
                                <td class="text-slate-800">Kelas</td>
                                <td class="text-slate-600">:</td>
                                <td class="text-slate-600 font-light">{{ $schedule->class->name }}</td>
                            </tr>
                            <tr class="border-b">
                                <td class="text-slate-800">Pengajar</td>
                                <td class="text-slate-600">:</td>
                                <td class="text-slate-600 font-light">{{ $schedule->staff->name }}</td>
                            </tr>
                            <tr class="border-b">
                                <td class="text-slate-800">Hari</td>
                                <td class="text-slate-600">:</td>
                                <td class="text-slate-600 font-light">{{ $schedule->day }}</td>
                            </tr>
                            <tr class="border-b">
                                <td class="text-slate-800">Jam Pelajaran</td>
                                <td class="text-slate-600">:</td>
                                <td class="text-slate-600 font-light">{{ $schedule->start_time }} -
