...
@section('content')
    <div class="grid grid-cols-1 rounded-lg bg-white px-5 py-6">
        <div class="header flex flex-col items-center justify-between gap-5 border-b pb-5 md:flex-row">
            <div>
                <h1 class="text-lg font-semibold text-red-600"><i class="bi bi-book-half pe-2"></i> Daftar Muatan Mata Pelajaran</h1>
            </div>
            <div>
                <a href="/muatan-mapel/create">
                    ...
                    @foreach ($subject_content as $s)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="/muatan-mapel/{{ Crypt::encrypt($s->id_subcontent) }}/edit"><i class="bi bi-pencil-square mr-3 text-lg text-green-600 hover:text-green-900"></i></a>
                                <a href="/muatan-mapel/{{ Crypt::encrypt($s->id_subcontent) }}/delete"><i class="bi bi-trash text-lg text-green-600 hover:text-green-900"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
